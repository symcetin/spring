...
public interface TicketRepository extends JpaRepository<Ticket, Long> {
    ...
    List<Ticket> findTicketsByUserAccount(@Param("userId") Long userId);
    ...
    Integer countTicketByUserInDateRange(@Param("userID") Long userId,@Param("dataTime1") LocalDateTime dateTime1,@Param("dateTime2") LocalDateTime dateTime2);
